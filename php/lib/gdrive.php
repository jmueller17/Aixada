...
@require_once (__ROOT__.'external/php53_2/ZendGdata-1.12.2/library/Zend/Loader.php');
set_include_path(__ROOT__.DIRNAME('external/php53_2/ZendGdata-1.12.2/library/.').PATH_SEPARATOR.".");
