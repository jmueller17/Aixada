...
/**
 * Distributors manage groups of providers
 */
create table aixada_distributor (
  id   	          	int		not null auto_increment,
  name	     	  	varchar(255) 	not null,
  contact               varchar(255)    default null,
  address		varchar(255)    default null,
...
create table aixada_providers_of_distributor (
  id                    int             not null auto_increment,
  distributor_id        int             not null,
  provider_id           int             not null,
  primary key (id),
  foreign key (distributor_id) references aixada_distributor(id),
...
create table aixada_user (
  ...
  color_scheme_id        tinyint        default 1,
...
/**
 * exceptional days where shopping is allowed or forbidden
 */
create table aixada_shopping_dates (
  shopping_date    date,
...
/**
 *  An auxiliary table to speed up the search for accounts with negative balance
 */

create table aixada_account_balance (
  account_id            int             not null,
  balance               decimal(10,2)   not null default 0.0,
