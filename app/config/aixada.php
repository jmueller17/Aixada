...
$aixada_config = array(
  ...
  ****************************************************************************/
   ...
   * @var string
   */
	'default_theme' => "smoothness", // start | ui-lightness | smoothness | redmond
   ...
   * @var string
   */
	'print_my_orders_template' => 'order_model1.php',
   ...
   * @var unknown_type
   */
	'print_bill_template' => 'bill_model1.php',
   ...
   */
	'print_incidents_template' => 'incidents_model1.php',
   ...
   */
	'show_menu_language_select' => false, 
  ...
  'main_nav' => array(
                ...
                'manage' => array(
                  ...
                  'subnav' => array(
                      'providers' => array(
                        'i18n' => 'nav_mng_providers',
                        'path' => 'manage_providers.php',
                        'params' => '',
                        'title' => ''
                        ),
                      'orders' => array(
                        'i18n' => 'nav_mng_orders',
                        'path' => 'manage_orders.php',
                        'params' => '',
                        'title' => ''
