<script type="text/javascript">
    <?php if (is_created_session()) : ?>
            (function() {
                ...
                if (stagewrap) stagewrap.style.visibility = "hidden";
                ...
                ajax.onreadystatechange = function() {
                    if (this.readyState === 4) {
                        ...
                        if (stagewrap) stagewrap.style.visibility = "visible";
                    }
                }
                ...
                function onLoad(doc) {
                    ...
                    if (result > 0) {
                        ...
                        if (lastDateDaysDelta > gracePeriodeDays && "<?= $_SERVER['REQUEST_URI'] ?>".match(/shop_and_order\.php/)) {
                            debugger;
                            var newContent = document.createElement("div");
                            newContent.id = "noMoneyBlock";
                        ...
                        warningNode.id = "warningBanner";
                        warningNode.innerHTML =
                            "<?= $Text["negative_balance_warning"] ?>" + new Intl.NumberFormat("<?= configuration_vars::get_instance()->type_formats['numbers']['locale']; ?>", {
                                style: "currency",
                                currency: "<?= configuration_vars::get_instance()->currency_iso; ?>"
                            }).format(result) + "<br><?= $Text["negative_balance_warning_order"]; ?>.";
