...
class canned_table_manager {
 ...
 case 'aixada_iva_type':
     return "['id','Percentatge','Descripci\u00f3']";

 case 'aixada_member':
     return "['id','Ref. personalitzada','TRANSLATION(uf)','Nom','Adre\u00e7a','NIF','CP','Localitat','Tel\u00e8fon1','Tel\u00e8fon2','URL','Imatge','Observacions','Actiu','Participant','Adult','TRANSLATION(ts)']";
