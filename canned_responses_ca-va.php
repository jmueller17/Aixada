...
class canned_table_manager {
 ...
 case 'aixada_iva_type':
     return "['id','TRANSLATION(percent)','Descripci\u00f3']";

 case 'aixada_member':
     return "['id','TRANSLATION(custom_member_ref)','TRANSLATION(uf)','Nom','Adre\u00e7a','TRANSLATION(nif)','CP','Localitat','Tel\u00e8fon1','Tel\u00e8fon2','URL','TRANSLATION(picture)','Observacions','Actiu','Participant','TRANSLATION(adult)','TRANSLATION(ts)']";

 case 'aixada_order':
     return "['id','Prove\u00efdor','TRANSLATION(date_for_order)','TRANSLATION(ts_sent_off)','TRANSLATION(date_received)','Data de compra','TRANSLATION(total)','Observacions','TRANSLATION(revision_status)','TRANSLATION(delivery_ref)','TRANSLATION(payment_ref)']";
