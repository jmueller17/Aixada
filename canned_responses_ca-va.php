...
class canned_table_manager {
 ...
 case 'aixada_cart':
     return "['id','Nom','TRANSLATION(uf)','Data de compra','Usuari','Validada','TRANSLATION(ts_last_saved)']";

 case 'aixada_currency':
     return "['id','Nom','TRANSLATION(one_euro)']";

 case 'aixada_incident':
     return "['id','Assumpte','Tipus','Usuari','Detalls','Prioritat','UFs afectades','TRANSLATION(commission_concerned)','Per al prove\u00efdor','TRANSLATION(ts)','Estat']";
 ...
 case 'aixada_price':
     return "['TRANSLATION(product)','TRANSLATION(ts)','TRANSLATION(current_price)','Usuari']";
 ...
 case 'aixada_stock_movement':
     return "['id','TRANSLATION(product)','Usuari','TRANSLATION(amount_difference)','Descripci\u00f3','TRANSLATION(resulting_amount)','TRANSLATION(ts)']";
