...
class canned_table_manager {
 ...
 case 'aixada_account_desc':
     return "['id','Descripci\u00f3','TRANSLATION(account_type)','Actiu']";
 ...
 case 'aixada_order_item':
     return "['id','TRANSLATION(uf)','TRANSLATION(favorite_cart)','TRANSLATION(order_id)','TRANSLATION(unit_price_stamp)','Percentatge d_IVA','TRANSLATION(rev_tax_percent)','Data d_entrega','TRANSLATION(product)','Quantitat','TRANSLATION(ts_ordered)']";

 case 'aixada_order_to_shop':
     return "['TRANSLATION(order_item_id)','TRANSLATION(uf)','TRANSLATION(order_id)','TRANSLATION(unit_price_stamp)','Percentatge d_IVA','TRANSLATION(rev_tax_percent)','TRANSLATION(product)','Quantitat','Arribat','TRANSLATION(revised)','TRANSLATION(aixada_order_to_shop_ibfk_1)','TRANSLATION(aixada_order_to_shop_ibfk_2)','TRANSLATION(aixada_order_to_shop_ibfk_3)']";
