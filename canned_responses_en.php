...
class canned_table_manager {
 ...
 case 'aixada_cart':
     return "['id','Name','TRANSLATION(uf)','Shop date','Operator','Validated','TRANSLATION(ts_last_saved)']";

 case 'aixada_currency':
     return "['id','Name','TRANSLATION(one_euro)']";

 case 'aixada_incident':
     return "['id','Subject','Type','Operator','Details','Priority','HUs concerned','TRANSLATION(commission_concerned)','For provider','TRANSLATION(ts)','Status']";
 ...
 case 'aixada_price':
     return "['TRANSLATION(product)','TRANSLATION(ts)','TRANSLATION(current_price)','Operator']";
 ...
 case 'aixada_stock_movement':
     return "['id','TRANSLATION(product)','Operator','TRANSLATION(amount_difference)','Description','TRANSLATION(resulting_amount)','TRANSLATION(ts)']";
