...
class canned_table_manager {
 ...
 case 'aixada_account_desc':
     return "['id','Description','TRANSLATION(account_type)','Active']";
 ...
 case 'aixada_order_item':
     return "['id','TRANSLATION(uf)','TRANSLATION(favorite_cart)','TRANSLATION(order_id)','TRANSLATION(unit_price_stamp)','VAT in percent','TRANSLATION(rev_tax_percent)','Delivery date','TRANSLATION(product)','Quantity','TRANSLATION(ts_ordered)']";

 case 'aixada_order_to_shop':
     return "['TRANSLATION(order_item_id)','TRANSLATION(uf)','TRANSLATION(order_id)','TRANSLATION(unit_price_stamp)','VAT in percent','TRANSLATION(rev_tax_percent)','TRANSLATION(product)','Quantity','Arrived','TRANSLATION(revised)','TRANSLATION(aixada_order_to_shop_ibfk_1)','TRANSLATION(aixada_order_to_shop_ibfk_2)','TRANSLATION(aixada_order_to_shop_ibfk_3)']";
