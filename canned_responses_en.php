...
class canned_table_manager {
 ...
 case 'aixada_member':
     return "['id','TRANSLATION(uf)','Name','Address','NIF','Zip','City','Phone1','Phone2','URLs','Picture','Notes','Active','Participant','Adult','TRANSLATION(ts)']";

 case 'aixada_order':
     return "['id','Provider','TRANSLATION(date_for_order)','TRANSLATION(ts_send_off)','TRANSLATION(date_received)','Date shopped','TRANSLATION(total)','Notes','TRANSLATION(revision_status)','TRANSLATION(delivery_ref)','TRANSLATION(payment_ref)']";
 ...
 case 'aixada_iva_type':
     return "[{name:'id',index:'id',label:'id',width:'6',xmlmap:'id',editable:false,hidden:false,editrules:{edithidden:true,searchhidden:true}},{name:'percent',index:'percent',label:'Percent',width:'150',xmlmap:'percent',editable:true,hidden:true,editrules:{edithidden:true,searchhidden:true}}]";
