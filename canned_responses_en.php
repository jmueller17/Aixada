...
class canned_table_manager {
 ...
 case 'aixada_member':
     return "['id','Custom ref.','TRANSLATION(uf)','Name','Address','VAT Reg No','Zip','City','Phone1','Phone2','Web','Bank account','Bank','Picture','Notes','Active','Participant','Adult','TRANSLATION(ts)']";
