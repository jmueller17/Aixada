...
class canned_table_manager {
 ...
 case 'aixada_order':
     return "['id','Provider','TRANSLATION(date_for_order)','TRANSLATION(ts_send_off)','TRANSLATION(date_received)','Date shopped','Total','Notes','TRANSLATION(revision_status)','TRANSLATION(delivery_ref)','TRANSLATION(payment_ref)']";
