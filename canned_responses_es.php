...
class canned_table_manager {
 ...
 case 'aixada_cart':
     return "['id','Nombre','TRANSLATION(uf)','Fecha de compra','Usuario','Validada','TRANSLATION(ts_last_saved)']";

 case 'aixada_currency':
     return "['id','Nombre','TRANSLATION(one_euro)']";

 case 'aixada_incident':
     return "['id','Asunto','Tipo','Usuario','Detalles','Prioridad','UFs afectadas','TRANSLATION(commission_concerned)','Para el proveedor','TRANSLATION(ts)','Estado']";
 ...
 case 'aixada_price':
     return "['TRANSLATION(product)','TRANSLATION(ts)','TRANSLATION(current_price)','Usuario']";
 ...
 case 'aixada_stock_movement':
     return "['id','TRANSLATION(product)','Usuario','TRANSLATION(amount_difference)','Descripci\u00f3n','TRANSLATION(resulting_amount)','TRANSLATION(ts)']";
 ...
 case 'aixada_user_role':
     return "['TRANSLATION(user)','TRANSLATION(role)']";
 ...
 case 'aixada_user_role':
     return "[{name:'user_id',index:'user',label:'TRANSLATION(user_id)',width:'300',xmlmap:'user',editable:true,hidden:true,editrules:{edithidden:true,searchhidden:true},edittype:'select',editoptions:{dataUrl:'php\/ctrl\/SmallQ.php?oper=getFieldOptions&table=aixada_user&field1=id&field2=login'}},{name:'role',index:'role',label:'TRANSLATION(role)',width:'100',xmlmap:'role',editable:true,hidden:true,editrules:{edithidden:true,searchhidden:true}}]";
 ...
 case 'aixada_cart':
     return "[uf_id,operator_id]";

 case 'aixada_currency':
     return "[]";

 case 'aixada_incident':
     return "[incident_type_id,operator_id]";
