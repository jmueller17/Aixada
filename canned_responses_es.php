...
class canned_table_manager {
 ...
 case 'aixada_member':
     return "['id','TRANSLATION(uf)','Nombre','Direcci\u00f3n','TRANSLATION(nif)','CP','Localidad','Tel\u00e9fono1','Tel\u00e9fono2','URL','TRANSLATION(picture)','Observaciones','Activo','Participante','TRANSLATION(adult)','TRANSLATION(ts)']";

 case 'aixada_order':
     return "['id','Proveedor','TRANSLATION(date_for_order)','TRANSLATION(ts_send_off)','TRANSLATION(date_received)','Fecha de compra','TRANSLATION(total)','Observaciones','TRANSLATION(revision_status)','TRANSLATION(delivery_ref)','TRANSLATION(payment_ref)']";
