...
class canned_table_manager {
 ...
 case 'aixada_member':
     return "['id','Ref. Personalizada','TRANSLATION(uf)','Nombre','Direcci\u00f3n','NIF','CP','Localidad','Tel\u00e9fono1','Tel\u00e9fono2','URL','Imagen','Observaciones','Activo','Participante','Adulto','TRANSLATION(ts)']";
 ...
 case 'aixada_product':
     return "['id','Proveedor','Nombre','Descripci\u00f3n','C\u00f3digo de barras','Activo','Unidad familiar responsable','Tipo de producto','Categor\u00eda','Tipo de impuesto revolucionario','Porcentaje de IVA','Precio por unidad','Unidades para el pedido','Unidades para la venta','Cantidad m\u00ednima para tener en stock','Cantidad actual en stock','Diferencia con el stock m\u00ednimo','URL de descripci\u00f3n','Imagen','TRANSLATION(ts)']";
