...
class canned_table_manager {
 ...
 case 'aixada_member':
     return "['id','Ref. Personalizada','TRANSLATION(uf)','Nombre','Direcci\u00f3n','TRANSLATION(nif)','CP','Localidad','Tel\u00e9fono1','Tel\u00e9fono2','URL','TRANSLATION(picture)','Observaciones','Activo','Participante','TRANSLATION(adult)','TRANSLATION(ts)']";
