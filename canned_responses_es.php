...
class canned_table_manager {
 ...
 case 'aixada_cart':
     return "['id','Nombre','TRANSLATION(uf)','Fecha de compra','TRANSLATION(operator_id)','Validada']";
 ...
 case 'aixada_iva_type':
     return "['id','TRANSLATION(percent)','Descripci\u00f3n']";

 case 'aixada_member':
     return "['id','TRANSLATION(custom_member_ref)','TRANSLATION(uf)','Nombre','Direcci\u00f3n','TRANSLATION(nif)','CP','Localidad','Tel\u00e9fono1','Tel\u00e9fono2','URL','TRANSLATION(picture)','Observaciones','Activo','Participante','TRANSLATION(adult)','TRANSLATION(ts)']";

 case 'aixada_order':
     return "['id','Proveedor','TRANSLATION(date_for_order)','TRANSLATION(ts_sent_off)','TRANSLATION(date_received)','Fecha de compra','TRANSLATION(total)','Observaciones','TRANSLATION(revision_status)','TRANSLATION(delivery_ref)','TRANSLATION(payment_ref)']";

 case 'aixada_order_item':
     return "['id','TRANSLATION(order_id)','TRANSLATION(unit_price_stamp)','TRANSLATION(date_for_order)','TRANSLATION(uf)','TRANSLATION(favorite_cart)','TRANSLATION(product)','Cantidad','TRANSLATION(ts_ordered)']";

 case 'aixada_order_to_shop':
     return "['TRANSLATION(order_item_id)','TRANSLATION(uf)','TRANSLATION(order_id)','TRANSLATION(unit_price_stamp)','TRANSLATION(product)','Cantidad','TRANSLATION(arrived)','TRANSLATION(revised)','TRANSLATION(aixada_order_to_shop_ibfk_1)','TRANSLATION(aixada_order_to_shop_ibfk_2)','TRANSLATION(aixada_order_to_shop_ibfk_3)']";
 ...
 case 'aixada_provider':
     return "['id','Nombre','Contacto','Direcci\u00f3n','TRANSLATION(nif)','CP','Localidad','Tel\u00e9fono1','Tel\u00e9fono2','Fax','Correo electr\u00f3nico','URL','TRANSLATION(bank_name)','TRANSLATION(bank_account)','TRANSLATION(picture)','Observaciones','Activo','Unidad familiar responsable','TRANSLATION(offset_order_close)','TRANSLATION(ts)']";
 ...
 case 'aixada_user':
     return "['id','Inicio de sesi\u00f3n','TRANSLATION(password)','Correo electr\u00f3nico','TRANSLATION(uf)','TRANSLATION(member)','Proveedor','TRANSLATION(language)','TRANSLATION(gui_theme)','TRANSLATION(last_login_attempt)','TRANSLATION(last_successful_login)','TRANSLATION(created_on)']";
