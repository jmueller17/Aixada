...
class canned_table_manager {
 ...
 case 'aixada_member':
     return "['id','Ref. personalizada','TRANSLATION(uf)','Nombre','Direcci\u00f3n','NIF','CP','Localidad','Tel\u00e9fono1','Tel\u00e9fono2','URL','Cuenta bancario','Banco o Caja','Imagen','Observaciones','Activo','Participante','Adulto','TRANSLATION(ts)']";
